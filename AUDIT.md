...
> Restent ouverts (aucun bloquant, aucun de sécurité) : P1 (adoption écran par écran des pages), P9 (état d'erreur à étendre au-delà de 3 écrans), A2b (badges sémantiques et boutons secondaires, 17 textes), A6 (`scope` sur les tables restantes — 12 fichiers sur 30 traités), S9 (choix produit : persistance des interrupteurs de délégation conservée), T1/T3 (couverture, e2e versionnés).
