...
@Component({
  ...
  styles: `
    ...
    .ppm-doc__table { border-collapse: collapse; width: 100%; table-layout: fixed; font-size: 0.64rem; }
    /* En-têtes et textes longs (OBJET, NATURE, SERVICE) : retour à la ligne. */
    ...
    /* Montants et dates : sur une seule ligne (pas de coupure). */
