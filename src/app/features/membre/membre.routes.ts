...
export const MEMBRE_ROUTES: Routes = [
  ...
  { path: 'examens', component: DossiersPipeline, data: { title: 'Dossiers à examiner', timeline: false, examenAction: true } },
  { path: 'examines', component: DossiersPipeline, data: { title: 'Dossiers examinés', examinedOnly: true, timeline: false } },
