...
@Component({
    ...
    <section class="md">
      ...
      @if (loading()) {
        ...
        <div class="md__kpis">
          ...
          @for (g of cfg.groupes; track g.key) {
        ...
        <div class="md__grid">
          @for (t of types(); track t.idTypeDossier) {
            <article class="md__card"><div class="md__inner">
              ...
              <div class="md__rows">
                @for (g of cfg.groupes; track g.key) {
                  <a class="md__row" [routerLink]="[cfg.base, t.idTypeDossier, g.key]">
  ...
  styles: `
    ...
    .md__row { display: flex; align-items: center; gap: 0.65rem; padding: 0.55rem 0.55rem; border-radius: var(--radius-md); color: var(--n-700); text-decoration: none; transition: var(--transition); }
