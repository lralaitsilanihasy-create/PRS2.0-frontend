...
export interface FieldConfig {
  ...
  hideInList?: boolean;
  /**
   * Masque le champ du **formulaire** (il reste en colonne de liste). Pour les valeurs **dérivées côté
   * serveur** que l'utilisateur ne saisit pas (ex. `niveauHierarchique` déduit de la catégorie).
   */
  hideInForm?: boolean;
  /**
