...
const QUI = {
  ...
  'B03-AJ-01': ['Durée des antécédents juridiques (années) — **code proposé**, N3', 'fiche (défaut administrable : 5)'],
  'B03-AJ-01.lettres': ['la même durée en toutes lettres', 'serveur'],
  'B03-AF-01.lettres': ['Durée des antécédents financiers, en toutes lettres — **code proposé**, N3', 'fiche (défaut administrable : 3)'],
