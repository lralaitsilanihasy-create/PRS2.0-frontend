 ...
 * ranger. Remise et ouverture des plis au 09/11/2026, attribution au 10/12/2026, notification au 28/01/2027.
 * ⚠️ Toutes ces dates sont des hypothèses [H] (le dossier les laisse en blanc) : elles suivent le §8 de
 * docs/jeu-donnees-2463-faits.md, qui FAIT FOI (arbitrage du pilote, 26/09) — lancement de l'avis (étape 111)
 * le 09/10/2026, décision d'attribution (étape 123) le 10/12/2026. Jours ouvrés, étapes dans l'ordre du référentiel.
 */
const PROCESSUS = [
